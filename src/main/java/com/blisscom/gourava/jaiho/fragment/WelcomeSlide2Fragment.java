...
public class WelcomeSlide2Fragment extends android.support.v4.app.Fragment {

    public static final String EXTRA_MESSAGE = "EXTRA_MESSAGE";
    private Activity activity;
    private ImageView imageView;

    public static final WelcomeSlide2Fragment newInstance(String message) {
        WelcomeSlide2Fragment f = new WelcomeSlide2Fragment();
