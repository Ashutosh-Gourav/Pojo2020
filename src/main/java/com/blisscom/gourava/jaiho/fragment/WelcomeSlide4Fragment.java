...
public class WelcomeSlide4Fragment extends android.support.v4.app.Fragment {

    public static final String EXTRA_MESSAGE = "EXTRA_MESSAGE";
    private Activity activity;
    private ImageView imageView;

    public static final WelcomeSlide4Fragment newInstance(String message) {
        WelcomeSlide4Fragment f = new WelcomeSlide4Fragment();
