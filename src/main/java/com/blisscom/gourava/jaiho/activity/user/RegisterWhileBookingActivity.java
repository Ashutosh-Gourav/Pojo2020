...
public class RegisterWhileBookingActivity extends FragmentActivity implements View.OnClickListener, View.OnTouchListener {
...
//        setRetainInstance(true);
        ...
        setContentView(R.layout.activity_register_while_booking);

        registerButton = (Button)findViewById(R.id.userRegButton);
        registerButton.setOnClickListener(this);
        nameET = (EditText)findViewById(R.id.register_user_name_et);
        phoneET = (EditText)findViewById(R.id.register_user_phone_ET);
//        phoneET.setText(getArguments().getString("userEnteredPhoneNumber"));
        pwdET = (EditText)findViewById(R.id.register_user_pwd_et);
//        pwdET.setText(getArguments().getString("userEnteredPassword"));
        mailET = (EditText)findViewById(R.id.register_user_mail_et);
        addressTV = (TextView)findViewById(R.id.register_user_address_tv);
        lookPasswordIV = (ImageView)findViewById(R.id.see_iv);
        lookPasswordIV.setOnClickListener(this);
        getLocationIV = (ImageView)findViewById(R.id.loc_iv);
...
//                    }
                    ...
                    if (ContextCompat.checkSelfPermission(this, Manifest.permission.READ_PHONE_STATE)
                        ...
                        RegistrationAsyncCall registrationAsyncCall = new RegistrationAsyncCall(this);
                        boolean isUserInBooking = true;
                        Object[] params = {mailET.getText().toString(), pwdET.getText().toString(), phoneET.getText().toString(), nameET.getText().toString(), addressTV.getText().toString(), isUserInBooking};
        ...
        if (!sharedPreferences.getBoolean(PojoPreferredStrings.IS_DO_NOT_SHOW_GPS_REQUEST_CHECKED.toString(), false)) {
            builder.setNeutralButton("OK", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    dialog.dismiss();
                    ActivityCompat.requestPermissions(RegisterWhileBookingActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, MY_PERMISSIONS_REQUEST_GPS);
                }
            });
        }else {
...
////        PojoLocationListener myLocationListener = new PojoLocationListener(this);
//        PojoGpsTracker gps = new PojoGpsTracker(this);
...
//                    requestPermissions(new String[]{Manifest.permission.READ_PHONE_STATE}, MY_PERMISSIONS_REQUEST_READ_PHONE_STATE);
                    ActivityCompat.requestPermissions(RegisterWhileBookingActivity.this, new String[]{Manifest.permission.READ_PHONE_STATE}, MY_PERMISSIONS_REQUEST_READ_PHONE_STATE);
...
//                    requestPermissions(new String[]{Manifest.permission.READ_PHONE_STATE}, MY_PERMISSIONS_REQUEST_READ_PHONE_STATE);
    ...
    public void onBackPressed(){
        super.onBackPressed();
        Intent intent = new Intent(this, LoginWhileBookingActivity.class);
        startActivity(intent);
        finish();
    }
