...
import com.blisscom.gourava.jaiho.infra.MyFirebaseInstanceIdService;
...
/**
 * Created by gourava on 12/19/16.
 */

public class RegistrationAsyncCall extends AsyncTask<Object, Integer, UserOtp> {
...
//private static String hostname = "http://192.168.1.100:8080/pojo";
    ...
    private static final String otp_confirmation_URI = "/svc/api/v1/user/confirm/otp";
    private boolean isComingFromBookingFlow;
    private String email, name, password, phoneNumber, address;
    private SharedPreferences sharedPreferences;

    public RegistrationAsyncCall(Context context) {
        super();
...
//        new WaitToShowProgress().execute();
    ...
    public UserOtp doInBackground(Object... params) {
        ...
        isComingFromBookingFlow = (boolean)params[5];
        ...
        try {
            ...
            phoneNumber = params[2].toString();
            password = params[1].toString();
            name = params[3].toString();
            body.put("email", email);
            body.put("password", password);
            body.put("mobileNumber", phoneNumber);
            body.put("fullname", name);
            body.put("registeredAddress", params[4].toString());
            ...
            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int id) {
                    ...
                    if (otpET.getText().toString() != null && otpET.getText().toString().equalsIgnoreCase(userOtp.getOtp())) {
                        new ConfirmOtpAndMAilAsyncCall().execute();
//                        sharedPreferences = context.getSharedPreferences(context.getString(R.string.shared_preference_name), Context.MODE_PRIVATE);
    ...
    private class ConfirmOtpAndMAilAsyncCall extends AsyncTask <Object, Integer, Integer>{
        ...
        protected Integer doInBackground(Object[] params) {
            ...
            try {
                ...
                Log.e("pojo", "cant read void response::::::"+e.getMessage());
            } catch (ResourceAccessException ex) {
                publishProgress(1);
                ex.printStackTrace();
                try {
                ...
                Log.e("pojo","error mail-otp request::::::"+ ex.getMessage());
                ...
                Log.e("pojo", "mail-otp went wrong::::::"+ex.getMessage());
        ...
        protected void onPostExecute(Integer statuscode) {
            if(statuscode != null && statuscode == HttpStatus.NO_CONTENT.value()){
                showLoadingDialog(R.string.registration_success_message);
//                new WaitToShowProgress().execute();
                sharedPreferences = context.getSharedPreferences(context.getString(R.string.shared_preference_name), Context.MODE_PRIVATE);
                SharedPreferences.Editor editor = sharedPreferences.edit();
                editor.putString(PojoPreferredStrings.POJO_USER_PHONE_NUMBER.toString(), phoneNumber);
                editor.putString(PojoPreferredStrings.POJO_USER_EMAIL.toString(), email);
                editor.putBoolean(PojoPreferredStrings.IS_USER_REGISTRATION_OTP_CONFIRMED.toString(), true);
                editor.commit();
                if(!isComingFromBookingFlow) {
//                    hideLoadingDialog();
